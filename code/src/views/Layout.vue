  ...
  <div id="app">
    <section class="app-wrapper">
      ...
      <ul class="app-menu"  v-if="this.$route.name !== 'search'">
        <router-link tag="li" class="app-menu-item" to="/layout/index">
          <div class="app-menu-item-icon"></div>
          <p class="app-menu-item-title">首页</p>
        </router-link>
        <router-link tag="li" class="app-menu-item" to="/layout/reward">
          <div class="app-menu-item-icon"></div>
          <p class="app-menu-item-title">开奖</p>
        </router-link>
        <router-link tag="li" class="app-menu-item" to="/layout/discovery">
          <div class="app-menu-item-icon"></div>
          <p class="app-menu-item-title">发现</p>
        </router-link>
        <router-link tag="li" class="app-menu-item" to="/selectAdministrator">
          <div class="app-menu-item-icon"></div>
